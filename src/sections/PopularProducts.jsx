    ...
    <>
      ...
      <div className='flex flex-col sm:flex-row justify-center items-center'>
        <div className='m-4 sm:w-1/4 text-center'>
          <img src="src/assets/images/shoe4.svg" alt="" />
        ...
        <div className='m-4 sm:w-1/4 text-center'>
          <img src="src/assets/images/shoe5.svg" alt="" />
          <h2 className='font-palanquin text-xl mt-4'>
            ⭐ (4.1)
            <br />
        ...
        <div className='m-4 sm:w-1/4 text-center'>
          <img src="src/assets/images/shoe6.svg" alt="" />
          <h2 className='font-palanquin text-xl mt-4'>
            ⭐ (4.6)
            <br />
        ...
        <div className='m-4 sm:w-1/4 text-center'>
          <img src="src/assets/images/shoe7.svg" alt="" />
          <h2 className='font-palanquin text-xl mt-4'>
            ⭐ (4.8)
            <br />
